...
class _HardGameScreenState extends State<HardGameScreen>
  ...
  void _veriCek() {
    try {
      ...
      _fakeReply4 = _a[_randomIndex][6].toString();
      _fakeReply5 = _a[_randomIndex][7].toString();
    } catch (e) {
      // ignore: avoid_print
      print(e.toString());
    }
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              _ColumnWidgets(
                backColor: _backColor,
                kontrol1: _gonder[4][1],
                kontrol2: _gonder[5][1],
                screenIndexCount: _screenIndexCount,
                replyText1: _gonder[4][0],
                replyText2: _gonder[5][0],
              ),
              const Spacer(),
            ],
          ),
...
class _GameScreenConstants {
  ...
  late String _fakeReply4 = '';
  late String _fakeReply5 = '';
